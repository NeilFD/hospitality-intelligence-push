        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <div className="flex flex-col gap-4">
                  <div className="border rounded-lg p-4 bg-gray-50">
                    {currentLogoUrl ? (
                      <div className="flex flex-col items-center">
                        <img src={currentLogoUrl} alt="Company Logo" className="h-20 mb-4 object-contain" />
                        <span className="text-sm text-gray-500">Current Logo</span>
                      </div>
                    ) : (
                      <div className="flex flex-col items-center">
                        <div className="h-20 w-full flex items-center justify-center mb-4 text-gray-300">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Recommended: Square PNG with transparent background, at least 200x200 pixels.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="custom" className="space-y-6">
            <div className="grid gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="primaryColor" className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-mono">{activeTheme.primaryColor}</span>
                    </Label>
                    <ColorPicker 
                  ...
                  <div>
                    <Label htmlFor="secondaryColor" className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-mono">{activeTheme.secondaryColor}</span>
                    </Label>
                    <ColorPicker 
                  ...
                  <div>
                    <Label htmlFor="accentColor" className="flex items-center justify-between">
                      <span>Accent Color</span>
                      <span className="text-xs font-mono">{activeTheme.accentColor}</span>
                    </Label>
                    <ColorPicker 
                  ...
                  <div>
                    <Label htmlFor="sidebarColor" className="flex items-center justify-between">
                      <span>Sidebar Color</span>
                      <span className="text-xs font-mono">{activeTheme.sidebarColor}</span>
                    </Label>
                    <ColorPicker 
                  ...
                  <div>
                    <Label htmlFor="buttonColor" className="flex items-center justify-between">
                      <span>Button Color</span>
                      <span className="text-xs font-mono">{activeTheme.buttonColor}</span>
                    </Label>
                    <ColorPicker 
                  ...
                  <div>
                    <Label htmlFor="textColor" className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-mono">{activeTheme.textColor}</span>
                    </Label>
                    <ColorPicker 
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium mb-3">Font Settings</h3>
                <div className="grid gap-2">
                  ...
                  <div 
                    className="p-4 border rounded-md mt-2 text-lg" 
