      ...
      <CardContent className="space-y-6">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="presets" className="space-y-6">
            <div className="grid gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  <Label htmlFor="logoUpload" className="flex items-center gap-2 mb-2">
                  ...
                  <div className="flex flex-col md:flex-row items-start gap-5">
                    <div className="w-full md:w-1/2 flex flex-col items-center justify-center">
                      {currentLogoUrl ? (
                        ...
                        <div className="w-48 h-48 border-2 border-dashed rounded-md flex items-center justify-center bg-gray-50">
                    ...
                    <div className="w-full md:w-1/2">
                      <div className="space-y-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Recommended: Square image, 512×512 pixels or larger, PNG or JPG format.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-4 space-y-3">
                  <Label htmlFor="fontSelect" className="flex items-center gap-2">
                    <span className="font-bold text-sm">System Font</span>
                  </Label>
                  
                  <Select 
                    value={activeTheme.customFont || "system-ui, sans-serif"} 
                  ...
                  <div className="p-4 border rounded-md" style={{ fontFamily: activeTheme.customFont }}>
          ...
          <TabsContent value="custom" className="space-y-6">
            <div className="grid gap-6">
              <div className="grid gap-4">
                <Label htmlFor="customThemeName" className="flex items-center gap-2">
                  <Palette className="h-5 w-5 text-muted-foreground" />
                  New Theme Name
                </Label>
                <Input 
              ...
              <div className="space-y-5">
                <h3 className="text-lg font-medium">Secondary Color</h3>
                <ColorPicker 
              ...
              <div className="space-y-5">
                <h3 className="text-lg font-medium">Text Color</h3>
                <ColorPicker 
