              ...
              <div className="grid gap-4">
                <div>
                  ...
                  <Input 
                    ...
                    onChange={handleInputChange}
                    className="w-full py-2 px-3 rounded-md border focus:ring-2 focus:ring-purple-400 transition-all duration-300"
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                    <div className="flex-shrink-0 w-32 h-32 bg-gray-50 rounded-md border flex items-center justify-center overflow-hidden">
                      {currentLogoUrl ? (
                        <img 
                          src={currentLogoUrl} 
                          alt="Logo" 
            ...
            <div className="grid gap-6">
              ...
              <div className="grid gap-4">
                <Label className="text-base flex items-center">
                  <div 
                    className="w-4 h-4 mr-2 rounded-full" 
                    style={{backgroundColor: activeTheme.sidebarColor}}
                  ></div>
                  Sidebar Color
                </Label>
                <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="grid gap-4">
                <Label htmlFor="font" className="text-base">Font Family</Label>
                <Select value={activeTheme.customFont || ''} onValueChange={handleSelectChange}>
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Select a font" />
                  </SelectTrigger>
                  <SelectContent>
                    {availableFonts.map((font: CustomFont) => (
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="active" className="text-base cursor-pointer flex items-center gap-2">
                  <span>Set as active theme</span>
                  <span className="text-xs text-muted-foreground">(applies immediately)</span>
                </Label>
                <Switch 
                  id="active" 
