  ...
  return <div className="backdrop-blur-xl bg-white/25 border border-white/30 rounded-2xl p-8 shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        scale: 0.97
          ...
          <Button type="submit" disabled={isLoading} className="w-full transition-all duration-300 relative overflow-hidden text-hi-purple bg-green-200 hover:bg-green-100">
