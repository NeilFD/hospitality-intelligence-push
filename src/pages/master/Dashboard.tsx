  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <Button 
          onClick={() => goToWeek(currentYear, currentMonth, 
            currentWeekIndex >= 0 ? currentWeekIndex + 1 : 1)}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button 
                ...
                className={isCurrentMonth ? "bg-tavern-blue hover:bg-tavern-blue-dark" : ""}
              >
                Today
              </Button>
              <Button 
          ...
          <div className="flex flex-col md:flex-row items-center justify-between mb-4">
            ...
            <div className="flex space-x-2">
              <Button 
                ...
                className="border-tavern-blue text-tavern-blue hover:bg-tavern-blue hover:text-white"
              >
                View Month Summary
              </Button>
            </div>
              ...
              <CardContent className="p-0">
                <div className="p-4 flex flex-col h-full">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <div className="flex items-center">
                        ...
                        {isCurrentWeek && (
                          <span className="ml-2 bg-tavern-blue text-white text-xs px-2 py-1 rounded-full">
                            Current
                          </span>
                        )}
                      </div>
                  ...
                  <div className="mt-auto">
                    <Button 
                      onClick={() => goToWeek(currentYear, currentMonth, weekNumber)}
                      variant={isCurrentWeek ? "default" : "outline"}
                      className={`w-full ${isCurrentWeek ? 'bg-tavern-blue hover:bg-tavern-blue-dark' : 'border-tavern-blue text-tavern-blue hover:bg-tavern-blue hover:text-white'}`}
                    >
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {[...Array(3)].map((_, i) => {
          ...
          return (
            <Card 
              key={`month-${i}`}
              className={`transition-all duration-200 hover:shadow-md ${isHighlighted ? 'border-tavern-blue/30' : ''}`}
            >
              ...
              <CardContent>
                <Button 
                  variant="outline" 
                  size="sm"
                  className="w-full border-tavern-blue text-tavern-blue hover:bg-tavern-blue hover:text-white"
