...
const Index = () => {
  ...
  if (isAuthenticated) {
    console.log('[Index] User is authenticated, redirecting to home dashboard');
    ...
    // Always redirect to Home dashboard as default landing page for authenticated users
