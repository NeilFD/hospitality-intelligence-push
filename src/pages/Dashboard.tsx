...
export default function Dashboard() {
  ...
  return <div className="container py-8 space-y-8">
      <h1 className="text-3xl font-bold text-tavern-blue mb-6 px-[40px]">The Tavern Kitchen Ledger</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="shadow-md border-tavern-blue-light/30 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300">
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <StatusBox label="GP Percentage" value={formatPercentage(currentMonthGP)} status={getGpStatus(currentMonthGP, 0.68)} className="w-full h-24" />
        ...
        <Card className="shadow-md border-tavern-blue-light/30 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300">
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <StatusBox label="GP Percentage" value={formatPercentage(gpPercentage)} status={getGpStatus(gpPercentage, 0.68)} className="w-full h-24" />
