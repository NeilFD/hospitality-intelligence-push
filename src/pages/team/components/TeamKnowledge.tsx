...
const TeamKnowledge: React.FC = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {/* Food Bible Card */}
      <Card className="overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 bg-white border-green-200 rounded-xl group">
      ...
      <Card className="overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 bg-white border-blue-200 rounded-xl group">
        <CardHeader className="pt-6 pb-0 px-6">
