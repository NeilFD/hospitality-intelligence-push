...
const TeamChat: React.FC<TeamChatProps> = ({ initialRoomId, compact, initialSidebarClosed = false }) => {
  ...
  const [sidebarMinimized, setSidebarMinimized] = useState(initialSidebarClosed);
